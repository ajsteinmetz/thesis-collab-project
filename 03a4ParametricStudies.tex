...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{figure} 
\centerline{\includegraphics[width=0.82\linewidth]{plots/nu_e_scattering_length_eta_0_23.pdf}}
\centerline{\includegraphics[width=0.82\linewidth]{plots/nu_mu_scattering_length_eta_0_23.pdf}}
...
%%%%%%%%%%%%%%%%%%%%
\begin{figure}
\centerline{\includegraphics[width=0.99\linewidth]{plots/region_plot_legend.pdf}
}
...
\end{align}
where $n_{\overline{n}}$ and $n_{\overline{p}}$ are negligible in the temperature range we consider here. Taking the ratio $\ell_f/b_f$, using charge neutrality\index{charge neutrality}, and introducing the entropy density\index{entropy!density} at freezeout we obtain
