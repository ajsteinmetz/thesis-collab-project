...
\begin{figure}
    \centering
    \includegraphics[width=0.90\linewidth]{plots/chap04cosmo/pmf.png}
...
\begin{figure}[ht]
 \centering
\includegraphics[width=0.90\linewidth]{plots/chap04cosmo/EEPlasmaDensityRatio_new01.jpg}
...
We then introduce a novel polarization fugacity\index{fugacity!polarization} $\xi_{\sigma,s}$ and polarization potential $\eta_{\sigma,s}=\sigma s\eta$. We propose the polarization potential follows analogous expressions as seen in \req{cpotential} obeying
\begin{align}
 \label{spotential}
...
\label{sec:chem}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\noindent Considering the temperature after neutrino freeze-out\index{neutrino!freeze-out}, the charge neutrality\index{charge neutrality} condition can be written as
\begin{align}
 \label{density_proton}
 \left(n_{e^{-}}-n_{e^{+}}\right)=n_{p}=X_p\,\left(\frac{n_{B}}{s_{\gamma,e}}\right)\,s_{\gamma,e},\qquad X_p\equiv\frac{n_p}{n_B}\,,
\end{align}
...
\begin{align}
    \frac{n_{B}}{s_{\gamma,e}} = \mathrm{const.}
\end{align}
...
\begin{figure}[ht]
 \centering
 \includegraphics[width=0.90\linewidth]{plots/chap04cosmo/thesis_gfac.pdf}
...
\begin{figure}[ht]
 \centering
 \includegraphics[clip, trim=0.0cm 0.0cm 0.0cm 0.0cm,width=0.95\linewidth]{plots/chap04cosmo/thesis_perlepton.png}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\noindent Up to this point, we have neglected the impact that a nonzero spin potential $\eta\neq0$ (and thus $\xi\neq1$) would have on the primordial $e^{+}e^{-}$ plasma magnetization. In the limit that $(m_{e}/T)^2\gg b_0$ the magnetization given in \req{arbg:1} and \req{arbg:2} is entirely controlled by the polarization fugacity\index{fugacity!polarization} $\xi$ asymmetry generated by the spin potential $\eta$ yielding up to first order $\mathcal{O}(b_{0})$ in magnetic scale
\begin{multline}
 \label{ferro}
...
\begin{figure}[ht]
 \centering
 \includegraphics[width=0.9\linewidth]{plots/chap04cosmo/Spinchemical_03.png}
 \caption{The spin potential $\eta$ and chemical potential\index{chemical potential} $\mu$ are plotted under the assumption of self-magnetization through a nonzero spin polarization in bulk of the plasma. \cccite{Steinmetz:2023nsc}}
 \label{fig:self} 
\end{figure}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{figure}[ht]
 \centering
 \includegraphics[width=0.90\linewidth]{plots/chap04cosmo/ElectronDensity_SpinChemicalPotential004.jpg}
