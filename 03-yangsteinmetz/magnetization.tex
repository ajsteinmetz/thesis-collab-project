...
Magnetized baryon inhomogeneities which in turn could produce anisotropies in the cosmic microwave background (CMB)~\cite{Jedamzik:2013gua,Abdalla:2022yfr}\index{CMB}. We note that according to Jedamzik~\cite{Jedamzik:2020krr} the presence of a intergalactic magnetic field of $B_\mathrm{PMF}\simeq0.1{\rm\ nG}$ could be sufficient to explain the Hubble tension.
