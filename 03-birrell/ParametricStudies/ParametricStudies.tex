...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{figure}[ht]
\centerline{\includegraphics[height=5.8cm]{03-birrell/ParametricStudies/delta_rho.eps}\hspace{-5mm}\includegraphics[height=5.8cm]{03-birrell/ParametricStudies/upsilon.eps}}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{figure}[ht]
\centerline{\includegraphics[height=5.8cm]{03-birrell/ParametricStudies/aT_gamma.eps}\hspace{-5mm}\includegraphics[height=5.8cm]{03-birrell/ParametricStudies/T_ratio.eps}}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{figure}[ht]
\centerline{\includegraphics[height=6.3cm]{03-birrell/ParametricStudies/nu_e_freezeout.eps}\hspace{5mm}\includegraphics[height=6.3cm]{03-birrell/ParametricStudies/nu_mu_freezeout.eps}}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{figure}[ht]
\centerline{\includegraphics[height=5.8cm]{03-birrell/ParametricStudies/delta_rho_GF.eps}\hspace{-5mm}\includegraphics[height=5.8cm]{03-birrell/ParametricStudies/upsilon_GF.eps}}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{figure}[ht]
\centerline{\includegraphics[height=5.8cm]{03-birrell/ParametricStudies/aT_gamma_GF.eps}\hspace{-5mm}\includegraphics[height=5.8cm]{03-birrell/ParametricStudies/T_ratio_GF.eps}}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{figure}[ht]
\centerline{\includegraphics[height=6.3cm]{03-birrell/ParametricStudies/nu_e_freezeout_GF.eps}\hspace{5mm}\includegraphics[height=6.3cm]{03-birrell/ParametricStudies/nu_mu_freezeout_GF.eps}}
