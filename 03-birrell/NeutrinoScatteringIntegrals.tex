...
\subsection{Total Collision Integral}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{figure}[h]
\centerline{\includegraphics[height=6cm]{./ParametricStudies/nu_e_scattering_length_eta_0_23-eps-converted-to.pdf}\includegraphics[height=6cm]{./ParametricStudies/nu_mu_scattering_length_eta_0_23-eps-converted-to.pdf}}
...
{\includegraphics[height=6.2cm]{./ScatteringIntegrals/Ups_relax-eps-converted-to.pdf}}
\makebox[0.5\linewidth]%
{\includegraphics[height=6.2cm]{./ScatteringIntegrals/T_relax-eps-converted-to.pdf}}
\end{minipage}
