...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{figure}%[h]
\centerline{\includegraphics[height=6cm]{03-birrell/NeutrinoDistributionToday/rel_v_dist_300.eps}}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{figure}%[h]
\centerline{\includegraphics[height=6cm]{03-birrell/NeutrinoDistributionToday/E_dist_300.eps}}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{figure}%[h]
\centerline{\includegraphics[height=7cm]{03-birrell/NeutrinoDistributionToday/flux_dist.eps}}
...
{\includegraphics[height=5.8cm]{03-birrell/NeutrinoDistributionToday/deBrogle_300.eps}}
\makebox[0.5\linewidth]%
{\includegraphics[height=5.8cm]{03-birrell/NeutrinoDistributionToday/f_ratio.eps}}
\end{minipage}
