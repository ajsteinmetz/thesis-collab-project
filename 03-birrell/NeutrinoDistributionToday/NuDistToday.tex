\chapter{Neutrinos Today}\label{ch:nu_today}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\section{Velocity, Energy, and Wavelength Distributions}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{figure}%[h]
\centerline{\includegraphics[height=6cm]{./NeutrinoDistributionToday/rel_v_dist_300-eps-converted-to.pdf}}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{figure}%[h]
\centerline{\includegraphics[height=6cm]{./NeutrinoDistributionToday/E_dist_300-eps-converted-to.pdf}}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{figure}%[h]
\centerline{\includegraphics[height=7cm]{./NeutrinoDistributionToday/flux_dist-eps-converted-to.pdf}}
...
{\includegraphics[height=5.8cm]{./NeutrinoDistributionToday/deBrogle_300-eps-converted-to.pdf}}
\makebox[0.5\linewidth]%
{\includegraphics[height=5.8cm]{./NeutrinoDistributionToday/f_ratio-eps-converted-to.pdf}}
\end{minipage}
