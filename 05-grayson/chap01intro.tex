...
We also hope to generalize this framework to involve a Vlasov-Boltzmann equation\index{Vlasov-Boltzmann equation}  system that represents each plasma species with a different collision term. In matrix form, this system of Boltzmann equations for an electron-positron plasma would look like
