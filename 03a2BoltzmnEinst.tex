...
\end{align}
where $d\pi$ is the volume element on the future mass shell; here $g$ denotes the determinant of the metric tensor, $p_0=g_{0\alpha} p^\alpha$; non-bold $p$ are four-momenta while bold ${\bf p}$ denotes the spacial components; the upper signs are for fermions and the lower signs for bosons. See Appendix \ref{ch:vol:forms} for the derivation of the form of the volume element.
