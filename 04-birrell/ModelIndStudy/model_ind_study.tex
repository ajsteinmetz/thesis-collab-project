...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 
\paragraph{Neutrino Fugacity and Photon to Neutrino Temperature Ratio}%\label{Tnugam}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{Contribution to effective neutrino number from sub-eV mass sterile Particles}%\label{sec:Neff_QGP}
