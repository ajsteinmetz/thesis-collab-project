\subsection{Effective Number of Neutrinos  in the Instantaneous  Freeze-out Model}\label{sec:model:ind}
...
%%%%%%%%%%%%%%%%%%%%%%%%
\para{Dynamics and Conservation Laws}
...
Due to the assumed homogeneity and isotropy, the particle distribution function depends on $t$ and $p^0=E$ only and so the Einstein-Vlasov equation becomes\index{Einstein-Vlasov equation}\index{free-streaming}
...
The Fermi-Dirac-Einstein-Vlasov (FDEV) distribution function for neutrinos after freeze-out is then\index{Fermi-Dirac-Einstein-Vlasov distribution}
