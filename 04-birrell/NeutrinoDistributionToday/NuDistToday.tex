...
%%%%%%%%%%%%%%%%%
\paragraph{Neutrino Distribution in a Moving Frame}
...
%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{Velocity, Energy, and Wavelength Distributions}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{figure}
\centerline{\includegraphics[width=0.9\textwidth]{04-birrell/NeutrinoDistributionToday/Figures/rel_v_dist_300.eps}}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{figure}
\centerline{\includegraphics[width=0.9\textwidth]{04-birrell/NeutrinoDistributionToday/Figures/E_dist_300.eps}}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{figure}
\centerline{\includegraphics[width=0.9\textwidth]{04-birrell/NeutrinoDistributionToday/Figures/flux_dist.eps}}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{Prospects for Detecting Relic Neutrinos}
