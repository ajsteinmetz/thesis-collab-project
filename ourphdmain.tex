%%%%%%%%%%%%%%%%%%%%%%%% Springer-Verlag
\documentclass[epjST,usenames,dvipsnames]{svjour}
...
\include{00-hadron_rafelski/hadronuniverse}
...
\include{04-birrell/ModelIndStudy/model_ind_study.tex}
\include{04-birrell/ParametricStudies/ParametricStudies.tex}
...
\include{05-grayson/chap02QCD}
\include{05-grayson/chap03BBN}
%%%%%%%%%%%%%%%%%%%%%%%%
