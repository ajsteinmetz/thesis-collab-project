\section{Boltzmann-Einstein Equation Solver Adapted to Emergent Chemical Non-equilibrium}\label{ch:boltz:orthopoly}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\para{Non-equilibrium dynamics}\label{dynamics_sec}
