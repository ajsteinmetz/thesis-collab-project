...
%%%%%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{Orthogonal polynomials for systems close to kinetic and chemical equilibrium}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{Polynomial basis for systems   far from chemical equilibrium}\label{kinetic_eq_approach}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{Comparison of Bases}\label{basis_comparison}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{Dynamics}\label{dynamics_sec}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{Generalities}\label{ortho-general}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{Parametrized Families of Orthogonal Polynomials}\label{ortho-polynom-fam}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{Proof of Lower Triangularity}\label{lower_triang}
