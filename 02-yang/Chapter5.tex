...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{Muon pairs in the early Universe}\label{section_muon}
%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{Muon production processes}
...
\caption{The thermal reaction rate per unit time and units volume for different reactions as a function of temperature. The dominant reactions for $\mu^\pm$ production are ${\gamma+\gamma\to\mu^++\mu^-}$ and $e^++e^-\to\mu^++\mu^-$, and the total production rate crosses the decay rate of $\mu^\pm$ at temperature $T_{dissapear}\approx 4.195$\,MeV. \cccite{Rafelski:2023emw}, adapted from Ref.~\cite{Rafelski:2021aey} and thesis of C.T.\,Yang~\cite{Yang:2024ret}}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{Comparison of muon and baryon abundance}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{Electron chemical potential and number density.}\index{chemical potential!electron}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{QED plasma damping rate}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{Self-consistent damping rate}
...
\paragraph{Understanding Neutrons}\index{neutron}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{Decay Rate in Medium}
%\label{Rate_Medium}
