\subsection{Neutrinos in cosmic plasma }\label{Neutrino}
...
\subsubsection{Matrix element for neutrino coherent/ incoherent scattering}
...
\subsubsection{Long wavelength limit of neutrino-atom coherent scattering}\label{LongWavelength}
...
%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection{Matrix elements of incoherent neutrino scattering}
...
\subsubsection{Neutrinos in the early Universe }
