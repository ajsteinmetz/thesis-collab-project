...
The division of the freeze-out process into these three regimes is a simplification of much more complex overlapping dynamical processes. It is, however, a very useful approximation in the study of cosmology~\cite{Mangano:2005cc,Birrell:2014gea}, see also~\cite{Birrell:2012gg,Rafelski:2023emw}.
...
All three mass states remained relativistic until the temperature dropped below their rest mass. These results allow for the possibility that one mass eigenstate, or two mass eigenstates, of neutrinos may become nonrelativistic today. We will return in \rsec{ch:nu:today} to discuss the relic massive neutrino flux in the Universe.

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%\para{Neutrino freeze-out in the early Universe}
...
\caption{First hours in the evolution of the Universe: Hubble parameter $H$ in units [1/s] (left hand scale) and the redshift $1+z$ (right hand scale, blue) spanning the epoch from the end of baryon antimatter annihilation through BBN, compare~\rf{fig:BBN}. \radapt{Rafelski:2013yka}.
\label{fig:BBN1}}
\end{figure}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
 ...
 The dashed line shows the neutrino temperature, which decouples from the $e^\pm$ and photon temperature at $T={\cal O}(1\MeV)$ when neutrinos freeze-out and begin free streaming. In~\rf{fig:BBN} the unit of time is seconds and the range spans the domain from fractions of a millisecond to a few hours. After neutrino freeze-out we come to Big Bang Nucleosynthesis, the period when the lighter elements were synthesized in a hot but relatively dilute plasma~\cite{Iocco:2008va}. We left some time gap between this and the domain shown in \rf{fig:today} describing the current era -- there is an uneventful evolution between the two domains. 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{sidewaysfigure}
\vspace*{0.62\linewidth}{\includegraphics[width=\linewidth]{01-introduction/Figures/DOFtime.png}}
\caption{Universe inflation due to disappearance of degrees of freedom as a function of time $t$\,[ms] (milliseconds). The Universe volume inflated approximately by a factor of 27 above the naive thermal  redshift scale as massive particles disappeared successively from the inventory. \radapt{Birrell:2014ona}\label{fig:dof}}
 \end{sidewaysfigure}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
