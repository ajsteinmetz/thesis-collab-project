...
The collision micro-bang involves time scales many orders of magnitude shorter compared to the characteristic scale governing the Universe Big-Bang: The expansion time scale of the Universe is determined by the interplay of the gravitational force and the radiative and Fermi pressure of the hot matter, whereas in the micro-bangs there is no gravitation to slow the expansion, which lasts a fraction of $\tau_\mathrm{MB}\le 10^{-22}$\,s, the time for particles  to cross at the speed of light the localized fireball of matter generated in relativistic heavy ion collision.  

It is convenient to represent the Universe expansion time constant $\tau_{\mathrm U}$ in terms of the Newtonian gravitational constant $G_N$ and the  energy density scale of expanding volume  $\epsilon_0$ 
\beql{taudef}
\tau_{\mathrm U} = 
\sqrt{\frac{3c^2}{32\pi{G_N}\epsilon_0} }=
\frac{1}{c}\sqrt{\frac{ 3M_p^2c^4}{4\hbar c \epsilon_0}}= 158.4{\mu}\mathrm{s}\,,\qquad  
\epsilon_0 \simeq \frac{\mbox{GeV}}{\mbox{fm}^3} = \frac{( 296\,\mbox{MeV})^4}{(\hbar c)^3}.
\eeqn
The Planck mass $M_p$ is defined in terms of $G_N$
\beql{eq:GN}
...
The range of values for the parameter ${\cal B}$ found in literature, $145\,\mathrm{MeV}<{\cal B}^{1/4}<235$\,MeV, is characteristic of the energy density of hadron matter. It leads to $66\,\mu$s $>\tau_{\mathrm U}>25\,\mu$s. The Universe is indeed expected to be 16 orders slower in its expansion compared to the fireball forming laboratory experiments.

There are other important differences between the laboratory model and the cosmic reality: The early radiative  Universe was practically baryon free, the asymmetry level was and is $10^{-9}$, comparing to cosmic backgrounds of remnant particles. In the laboratory  we create  a fireball of dense matter with a considerable fraction of a percent level baryon number per total final particle multiplicity.  The matter-antimatter-abundance asymmetry difference between laboratory and early Universe is easily overcome theoretically, since it implies a relatively minor extrapolation, low abundance of baryons is a signal but not a key feature of matter produced.

More difficult to resolve is the difference  in the physics due to the different time scales involved. The evolution of the Universe is slow on the hadronic time scale. Given the value of characteristic $\tau_{\mathrm U}$ we obtained, we expect that practically all unstable hadronic particles evolve to fully attain equilibrium, and there  time to develop macroscopic structures called `mixed phase' of QGP and hadrons, and for electromagnetic and even weak interactions to take hold. All this can not occur during the life span of the dense matter created in relativistic nuclear-collisions. To understand the Universe we must use theoretical models as developed in this report. 

This takes us right to the question: Can we really tell apart in these explosive ultra relativistic heavy ion experiments the two different phases of strongly interacting matter, quark gluon plasma and normal confined strongly interacting matter? In the end the outcome of these collisions seems to be very much the same, we achieve the conversion of the  kinetic energy of colliding nuclei into many material particles. This question haunted this field of research for decades~\cite{Rafelski:2015cxa,Harris:2024aov}, a topic which is not addressed in this work beyond the following few words: 

When one of us (JR) first arrived at CERN in 1977, he found himself immersed into ardent discussions about both what the structure of the hot primordial Universe could be, and if indeed we could figure out the answer in an experiment: Was the Universe perhaps a dense baryon-antibaryon universe? Or was indeed the confinement condition not really retained at high temperature~\cite{Weinberg:1974hy,Harrington:1974fc,Cabibbo:1975ig}? And above all, how can we tell these models apart doing laboratory experiments? By 1979 it became clear that new ideas about experimental observable were needed based on specific properties of the dense hot matter if formed in experiments. Strange antibaryon enhancement was one of the proposed novel approaches and in the opinion of one of us (JR), this was to be later the decisive QGP discovery evidence.
