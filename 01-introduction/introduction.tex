...
All three mass states remained relativistic until the temperature dropped below their rest mass. These results allow for the possibility that one mass eigenstate, or two mass eigenstates, of neutrinos may become non-relativistic today. We will return in \rsec{ch:nu:today} to discuss the relic massive neutrino flux in the Universe.
