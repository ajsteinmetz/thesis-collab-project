...
\subsection{Overview} 
\label{sec:context}
This review collects  in edited and re-sequenced manner selected material from the contents of four PhD Thesis's completed at the Department of Physics, The University of Arizona by: \begin{enumerate}
...
\end{enumerate}
We also include additional review material from our recent publications reaching in part beyond the contents of the Thesis, which due to time constraints did not find its way into the formal thesis document~\cite{...}.
...
\caption{\cccite{universe9070309}, adapted from Ref.~\cite{Rafelski:2013yka}. Disappearance of degrees of freedom throughout the history of the Universe. The Universe volume inflated approximately by a factor of 27 above the thermal red shift scale as massive particles disappeared successively from the inventory.  The dashed portion is a qualitative description
...
\caption{\cccite{universe9070309}, adapted from \cite{Birrell:2014ona}. Current era: $69\%$ dark energy, $26\%$ dark matter, $5\%$ baryons, $<1\%$ photons and neutrinos, $1$ massless and $2\times .1$ eV neutrinos (Neutrino mass choice is just for illustration. Other values are possible). }
 \end{figure}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\caption{\cccite{Rafelski_2014}: Transition periods in the composition of the Universe: on left -- evolution of temperature $T$ and deceleration parameter $q$; on right -- evolution of the Hubble parameter $H$ and redshift $z$. 
\label{fig:today} }
\end{minipage}
\end{figure}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\caption{\cccite{Rafelski_2014}: From the end of baryon antimatter annihilation through BBN, see Figure \ref{fig:today}. % on left -- evolution of temperature $T$ and deceleration parameter $q$; on right -- evolution of the Hubble parameter $H$ and redshift $z$.
\label{fig:BBN} }
\end{minipage}
\end{figure}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\caption{Freeze-out temperatures for electron neutrinos (left) and $\mu$, $\tau$ neutrinos (right) for the three types of freeze-out processes adapted from  \cite{Birrell:2014uka}. Top panels print temperature curves as a function of $\sin^2\theta_W$ for $\eta=\eta_0$, the vertical dashed line is $\sin^2\theta_W=0.23$; bottom panels are printed as a function of relative change in interaction strength $\eta/\eta_0$ obtained for $\sin^2\theta_W=0.23$.}
