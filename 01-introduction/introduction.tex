...
\end{enumerate}
Due to graduation time constraints some of this presented material is only found in follow-up publications, see the list below, and in reports yet to be readied for publication. This content yes forward looking and reported in preliminary format. Additionally, material adapted from Refs.~\cite{Letessier:2002ony,Rafelski:2015cxa,Rafelski:2016hnq,Rafelski:2019twp} has been included. This allows to address strong interactions and quark-gluon plasma (QGP) hadronization in the Universe:
\begin{enumerate}
\item[i)] Deconfined states of hot quarks and gluons, the quark-gluon plasma (QGP); and
\item [ii)] hot hadronic phase of matter, as applicable to the context of the primordial Universe.
\end{enumerate}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
